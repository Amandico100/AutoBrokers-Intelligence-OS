...
2. Abra o arquivo `backend/supabase/migrations/schema_completo.sql`
3. Copie **TODO** o conteúdo e cole no SQL Editor
4. Clique em **Run** para executar

✅ Isso cria todas as tabelas, funções, triggers, índices e políticas RLS do Agent Smith V6.2.

> [!WARNING]
> **Já tem o Smith instalado (v6.0 ou v6.1)?** NÃO rode o `schema_completo.sql`!
> Em vez disso, rode o arquivo `backend/supabase/migrations/upgrade_v6.2.sql` no SQL Editor.
> Ele adiciona apenas as novas features (SubAgents, Sanitizer, File System Search, Performance Indexes, etc.) sem afetar seus dados existentes.
