...
@router.post("/tools")
async def create_http_tool(tool: HttpToolCreate, _: bool = Depends(require_master_admin)):
...
async def update_http_tool(tool_id: UUID, tool: HttpToolUpdate, _: bool = Depends(require_master_admin)):
...
async def delete_http_tool(tool_id: UUID, _: bool = Depends(require_master_admin)):
...
async def get_agent(agent_id: UUID, service: AgentService = Depends(get_agent_service), _: bool = Depends(require_master_admin)):
    """Get agent details"""
...
async def list_http_tools(agent_id: UUID, _: bool = Depends(require_master_admin)):
...
async def test_llm_integration(request: TestLLMRequest, _: bool = Depends(require_master_admin)):
    """
...
async def list_delegations(agent_id: UUID, _: bool = Depends(require_master_admin)):
...
async def create_delegation(delegation: DelegationCreate, _: bool = Depends(require_master_admin)):
...
async def update_delegation(delegation_id: UUID, delegation: DelegationUpdate, _: bool = Depends(require_master_admin)):
...
async def delete_delegation(delegation_id: UUID, _: bool = Depends(require_master_admin)):
