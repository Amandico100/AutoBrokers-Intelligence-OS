# Bancada · extrator_planos — corpus v3
...
app/services/knowledge/assistance_plans_extractor.py:propostas_da_pagina(llm=)

## De onde veio o texto
condicoes_gerais/*.json
...
ESQUELETO: 3 casos sem âncora (oráculo = nenhuma linha). O perfeito e o burro EMPATAM aqui — não é linha de controle até a v2 ter casos com âncora.

## Como rodar
```
cd backend
python scripts/bancada.py --papel extrator_planos --braco dublê:perfeito --braco dublê:burro --k 3 --nivel N1 --ensaio
```
