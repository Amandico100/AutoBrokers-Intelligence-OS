...
ESQUELETO: 3 casos; oráculo só por termo.

## Como rodar
```
cd backend
python scripts/bancada.py --papel hyde --braco dublê:perfeito --braco dublê:burro --k 3 --nivel N1 --ensaio
```
