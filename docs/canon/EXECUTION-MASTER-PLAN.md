...
| 6 | SPEC-057 — Artifact Hub & Report Studio | `feat/spec057-artifact-hub` | **PARCIAL** — 📊 verificado em 02/08/2026: 19 templates em `report_templates`, tabelas `artifacts`/`artifact_versions`/`artifact_renders` vivas, `report_tool` anexada ao chat. **Falta a rota de leitura de artifact na tela da corretora** (PENDENCIAS.md P-15) | — | — | reconciliado na SPEC-064 Bloco J |
| 7 | SPEC-052 Cognitive Foundation Closure | `feat/spec052-cognitive-foundation-closure` | NÃO INICIADO | — | — | — |
| 8 | SPEC-058 — Auxiliary & Routine Factory | `feat/spec058-auxiliary-routine-factory` | **PARCIAL** — 📊 verificado em 02/08/2026: `auxiliary_templates`, `tenant_auxiliaries`, `auxiliary_runs` e `factory_tool` existem e funcionam. A SPEC-064 acrescentou catálogo, configuração por corretora e execução pelo chat. **Falta escritor para `auxiliary_events`** (P-18) | — | — | reconciliado na SPEC-064 Bloco J |
